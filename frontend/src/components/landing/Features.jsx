      ...
      <section id="features" className="py-28 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Target, title: "ATS-Optimized Scoring", desc: "See exactly how ATS systems score your resume 90% accurate.", color: "from-blue-500 to-cyan-500" },
              ...
              { icon: Clock, title: "24h Auto-Delete", desc: "Your resume is encrypted and auto-deleted after 24h.", color: "from-green-500 to-emerald-500" },

              { icon: Award, title: "3+ Designer Templates", desc: "Recruiter-approved layouts for every industry.", color: "from-indigo-500 to-purple-500" }
            ].map((f, i) => (
              <ScaleOnView key={i} delay={i * 0.1}>
                <motion.div
                  whileHover={{ y: -10, scale: 1.02 }}
                  className="group relative items-center justify-center flex flex-col bg-slate-800/40 backdrop-blur-xl border border-slate-700/70 rounded-3xl p-8 hover:border-slate-600 transition-all"
                >
